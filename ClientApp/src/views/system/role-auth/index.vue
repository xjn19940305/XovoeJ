  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        type: 'page',
        children: [
          { id: '2-3-1', code: 'shop:category:view', label: '查看分类', type: 'button' },
          { id: '2-3-2', code: 'shop:category:create', label: '创建分类', type: 'button' },
          { id: '2-3-3', code: 'shop:category:edit', label: '编辑分类', type: 'button' },
          { id: '2-3-4', code: 'shop:category:delete', label: '删除分类', type: 'button' },
        ],
      },
      {
        id: '2-4',
        ...
        type: 'page',
        children: [
          { id: '2-4-1', code: 'shop:spec:view', label: '查看规格', type: 'button' },
          { id: '2-4-2', code: 'shop:spec:create', label: '创建规格', type: 'button' },
          { id: '2-4-3', code: 'shop:spec:edit', label: '编辑规格', type: 'button' },
          { id: '2-4-4', code: 'shop:spec:delete', label: '删除规格', type: 'button' },
        ],
      },
      {
        id: '2-5',
        ...
        type: 'page',
        children: [
          { id: '2-5-1', code: 'shop:order:view', label: '查看订单', type: 'button' },
          { id: '2-5-2', code: 'shop:order:create', label: '创建订单', type: 'button' },
          { id: '2-5-3', code: 'shop:order:edit', label: '编辑订单', type: 'button' },
          { id: '2-5-4', code: 'shop:order:delete', label: '删除订单', type: 'button' },
        ],
      },
    ],
  },
