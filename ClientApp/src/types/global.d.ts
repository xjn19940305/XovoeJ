...
// Element Plus 全局类型声明
declare global {
  const ElMessage: import('element-plus').ElMessage
  const ElMessageBox: import('element-plus').ElMessageBox
  const ElNotification: import('element-plus').ElNotification
}
